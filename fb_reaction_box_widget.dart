...
import 'package:ui_animation_testing_project/constants/emoji_keys.dart';

class FbReactionBox extends StatefulWidget {
  final FbReactionBoxArgument argument;

  const FbReactionBox({required Object? argument, super.key})
      : assert(argument != null && argument is FbReactionBoxArgument),
        argument = (argument as FbReactionBoxArgument);
...
class FbReactionBoxState extends State<FbReactionBox> with TickerProviderStateMixin {
  ...
  late Animation _pushEmojiLikeUp, _pushEmojiLoveUp, _pushEmojiHahaUp, _pushEmojiWowUp, _pushEmojiSadUp, _pushEmojiAngryUp;
  ...
  late Animation _moveLeftEmojiLikeWhenRelease, _moveLeftEmojiLoveWhenRelease, _moveLeftEmojiHahaWhenRelease, _moveLeftEmojiWowWhenRelease, _moveLeftEmojiSadWhenRelease, _moveLeftEmojiAngryWhenRelease;
  ...
  void _initAnimationBtnLike() {
    // long press
    _animControlBtnLongPress = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationBtnLongPress));
    ...
    // short press
    _animControlBtnShortPress = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationBtnShortPress));
  ...
  void _initAnimationEmojiWhenDrag() {
    _animControlEmojiWhenDrag = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationEmojiWhenDrag));
  ...
  void _initAnimationEmojiWhenDragOutside() {
    _animControlEmojiWhenDragOutside = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationEmojiWhenDrag));
  ...
  void _initAnimationBoxWhenDragOutside() {
    _animControlBoxWhenDragOutside = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationEmojiWhenDrag));
  ...
  void _initAnimationEmojiWhenDragInside() {
    _animControlEmojiWhenDragInside = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationEmojiWhenDrag));
  ...
  void _initAnimationEmojiWhenRelease() {
    _animControlEmojiWhenRelease = AnimationController(vsync: this, duration: Duration(milliseconds: _durationAnimationEmojiWhenRelease));

    _zoomEmojiWhenRelease = Tween(begin: 1.8, end: 0.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));

    _moveUpEmojiWhenRelease = Tween(begin: 180.0, end: 0.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));

    _moveLeftEmojiLikeWhenRelease = Tween(begin: 20.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
    _moveLeftEmojiLoveWhenRelease = Tween(begin: 68.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
    _moveLeftEmojiHahaWhenRelease = Tween(begin: 116.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
    _moveLeftEmojiWowWhenRelease = Tween(begin: 164.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
    _moveLeftEmojiSadWhenRelease = Tween(begin: 212.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
    _moveLeftEmojiAngryWhenRelease = Tween(begin: 260.0, end: 10.0).animate(CurvedAnimation(parent: _animControlEmojiWhenRelease, curve: Curves.decelerate));
              ...
              children: [
                ...
                _emojiUserChoose == ReactionEmoji.like && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiLikeWhenRelease.value,
                        ),
                ...
                _emojiUserChoose == ReactionEmoji.love && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiLoveWhenRelease.value,
                        ),
                        child: Transform.scale(
                          scale: _zoomEmojiWhenRelease.value,
                          child: Image.asset(
                ...
                _emojiUserChoose == ReactionEmoji.haha && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiHahaWhenRelease.value,
                        ),
                        child: Transform.scale(
                          scale: _zoomEmojiWhenRelease.value,
                          child: Image.asset(
                ...
                _emojiUserChoose == ReactionEmoji.wow && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiWowWhenRelease.value,
                        ),
                        child: Transform.scale(
                          scale: _zoomEmojiWhenRelease.value,
                          child: Image.asset(
                ...
                _emojiUserChoose == ReactionEmoji.sad && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiSadWhenRelease.value,
                        ),
                        child: Transform.scale(
                          scale: _zoomEmojiWhenRelease.value,
                          child: Image.asset(
                ...
                _emojiUserChoose == ReactionEmoji.angry && !_isDragging
                    ? Container(
                        margin: EdgeInsets.only(
                          top: _processTopPosition(_moveUpEmojiWhenRelease.value),
                          left: _moveLeftEmojiAngryWhenRelease.value,
                        ),
                        child: Transform.scale(
                          scale: _zoomEmojiWhenRelease.value,
                          child: Image.asset(
  ...
  Widget _renderEmoji() {
    return Container(
      width: 300.0,
      height: 250.0,
      margin: EdgeInsets.only(left: _moveRightGroupEmoji.value, top: 50.0),
      child: Row(
          ...
          Transform.scale(
            scale: _isDragging
                ? (_currentEmojiFocus == ReactionEmoji.like
                    ? _zoomEmojiChosen.value
                    : (_previousEmojiFocus == ReactionEmoji.like
                        ? _zoomEmojiNotChosen.value
                        : _isJustDragInside
                            ? _zoomEmojiWhenDragInside.value
                            : 0.8))
                : _isDraggingOutside
                    ? _zoomEmojiWhenDragOutside.value
                    : _zoomEmojiLike.value,
            child: Container(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              // Emoji like
              Transform.scale(
                scale: !_isLongPress ? _handleOutputRangeZoomInEmojiLike(_zoomEmojiLikeInBtn2.value) : _zoomEmojiLikeInBtn.value,
                child: Transform.rotate(
                  angle: !_isLongPress ? _handleOutputRangeTiltEmojiLike(_tiltEmojiLikeInBtn2.value) : _tiltEmojiLikeInBtn.value,
                  child: Image.asset(
                    _getImageEmojiBtn(),
                    width: 25.0,
                    height: 25.0,
              ...
              // Text like
              Transform.scale(
                scale: !_isLongPress ? _handleOutputRangeZoomInEmojiLike(_zoomEmojiLikeInBtn2.value) : _zoomTextLikeInBtn.value,
                child: Text(
                  _getTextBtn(),
                  style: TextStyle(
  ...
  void _onHorizontalDragEndBoxEmoji(DragEndDetails dragEndDetail) {
    ...
    _isLiked = false ;
    // widget.argument.onEmojiPressed(_getTextBtn());
    widget.argument.onEmojiPressed( _emojiUserChoose == ReactionEmoji.nothing && !_isLiked ? 'Nothing' : _getTextBtn());
...
class FbReactionBoxArgument {
  final void Function(String emojiText) onEmojiPressed; //A callback function to retrieve the emoji value

  FbReactionBoxArgument({required this.onEmojiPressed});
}
